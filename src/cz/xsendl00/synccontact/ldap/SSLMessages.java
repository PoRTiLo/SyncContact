...
/**
 * This enum defines a set of message keys for messages in the com.unboundid.util.ssl package, which
 * correspond to messages in the unboundid-ldapsdk-ssl.properties properties file. <BR>
 * <BR>
 * This source file was generated from the properties file. Do not edit it directly.
 */
enum SSLMessages {
  /**
   ...
   */
  ERR_KEYSTORE_CANNOT_GET_KEY_MANAGERS(
      "Unable to obtain key managers for key store file ''{0}'' using format ''{1}'':  {2}"),
   ...
   */
  ERR_PKCS11_CANNOT_GET_KEY_MANAGERS(
      "Unable to obtain key managers for the PKCS#11 key store:  {0}"),
   ...
   */
  ERR_TRUSTSTORE_CANNOT_GET_TRUST_MANAGERS(
      "Unable to obtain trust managers for trust store file ''{0}'' using format ''{1}'':  {2}"),
  ...
  /**
   * Retrieves a localized version of the message. This method should only be used for messages
